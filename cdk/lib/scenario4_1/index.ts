...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Scenario4-1';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からSCENARIO_4_1_FLAGから取得
    const flag = process.env.SCENARIO_4_1_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFrontURL', {
      exportName: 'Scenario4to1CloudFrontURL',
      description: 'Scerario4-1 CloudFront URL',
