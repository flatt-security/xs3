...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Scenario4-3';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からSCENARIO_4_3_FLAGから取得
    const flag = process.env.SCENARIO_4_3_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFrontURL', {
      exportName: 'Scenario4to3CloudFrontURL',
      description: 'Scerario4-3 CloudFront URL',
