...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Adv2';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からADV2_FLAGから取得
    const flag = process.env.ADV_2_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFront URL', {
      exportName: 'Adv2CloudFrontURL',
      description: 'Adv2 CloudFront URL',
