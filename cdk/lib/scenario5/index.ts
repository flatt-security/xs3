...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Scenario5';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からSCENARIO_5_FLAGから取得
    const flag = process.env.SCENARIO_5_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFront URL', {
      exportName: 'Scenario5CloudFrontURL',
      description: 'Scerario5 CloudFront URL',
