...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Scenario3';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からSCENARIO_3_FLAGから取得
    const flag = process.env.SCENARIO_3_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFront URL', {
      exportName: 'Scenario3CloudFrontURL',
      description: 'Scerario3 CloudFront URL',
