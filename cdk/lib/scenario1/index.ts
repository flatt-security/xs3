...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Scenario1';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からSCENARIO_1_FLAGから取得
    const flag = process.env.SCENARIO_1_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFront URL', {
      exportName: 'Scenario1CloudFrontURL',
      description: 'Scerario1 CloudFront URL',
