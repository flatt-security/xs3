...
import { uploadS3bucket, crawlingContentDeliveryS3bucket, assetsDeliveryS3bucket } from './s3';
...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Adv1';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    const assetsBucket = assetsDeliveryS3bucket(this, 'AssetsBucket', userUniqueId);
    ...
    const distribution = cloudFront(this, 'CloudFront', splitFunctionUrl, uploadBucket, deliveryBucket, assetsBucket);
    ...
    // FLAGを環境変数からADV_1_FLAGから取得
    const flag = process.env.ADV_1_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFront URL', {
      exportName: 'Adv1CloudFrontURL',
      description: 'Adv1 CloudFront URL',
