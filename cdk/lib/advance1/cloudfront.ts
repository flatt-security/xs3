 ...
 * @returns
 */
export const cloudFront = (scope: Construct, prefix: string, furl: string, bucket: Bucket, deliveryBucket: Bucket, assetsBucet: Bucket) => {
  const oai = createOriginAccessIdentity(scope, prefix);
  const props = createCloudFrontProps(prefix, furl, bucket, deliveryBucket, assetsBucet, oai);
...
const createCloudFrontProps = (prefix: string, furl: string, bucket: Bucket, deliveryBucket: Bucket, assetsBucet: Bucket, oai: OriginAccessIdentity) => {
