...
export class ScenarioStack extends cdk.Stack {
  static readonly StackName: string = 'Scenario2';
  constructor(scope: Construct, props: ScenarioStackProps) {
    ...
    // FLAGを環境変数からSCENARIO_2_FLAGから取得
    const flag = process.env.SCENARIO_2_FLAG;
    ...
    new cdk.CfnOutput(this, 'CloudFront URL', {
      exportName: 'Scenario2CloudFrontURL',
      description: 'Scerario2 CloudFront URL',
